...
from metapepview.backend.utils import check_file_presence
...
def download_gtdb_taxonomy(
    ...
    Args:
        ...
        fetch_zlib_archive (bool, optional): Download zlib compressed archive
            from metapepview.server to be decompressed in memory. Defaults to True.
    ...
    for file_name in GlobalConstants.gtdb_files:
        ...
        # fetch data from metapepview.server
